...
- **v2.38.0** *(เว็บ · BETA)* — 🎉 **Epic B จบ: ตัวติดตามนิสัยประจำวัน (Habit Tracker) — ประกาศอย่างเป็นทางการ** — รวม 4 slice เข้าด้วยกันแล้วเปิดตัว: การ์ด **"นิสัยประจำวัน"** ในหน้าแรก (พับ/ขยายได้) บันทึก **การนอน** (ชั่วโมง + คุณภาพ 😩😐😊😴), **ก้าวเดิน**, **อาหารเสริม** (วิตามินรวม/โอเมก้า 3/โปรไบโอติก/สังกะสี) · **สั่งงานด้วยเสียง 🎤** ในช่องค้นหาอาหาร (ไทย/อังกฤษ/จีน) · **ซิงค์นิสัยขึ้นคลาวด์** (ตาราง `habits` ใหม่ · ต้องรัน `calpro-database-v2.38-habits.sql` หนึ่งครั้ง · ถ้ายังไม่รันจะใช้แบบเก็บในเครื่องอย่างเดียวโดยอัตโนมัติ ไม่มี error) · self-test 27 ข้อผ่าน · **มี What's-new popup แจ้งฟีเจอร์**
- **v2.37.1** *(เว็บ · BETA · silent)* — 👣🎤 **Epic B (slice 2+3): ก้าวเดิน + สั่งงานด้วยเสียง** — เพิ่ม **"ก้าวเดิน"** ในการ์ดนิสัยประจำวัน (กรอกจำนวนก้าวรายวัน · เก็บในเครื่อง + สำรองลง IndexedDB) · เพิ่ม **ปุ่มไมค์ 🎤** ในช่องค้นหาอาหาร — พูดชื่อเมนู (ไทย/อังกฤษ/จีน) แล้วเติมให้อัตโนมัติพร้อมค้นหาเลย (Web Speech API · ภาษาตามที่ตั้งไว้ · ซ่อนปุ่มเองบนเบราว์เซอร์ที่ไม่รองรับ เช่น iOS Safari) · self-test 23 ข้อผ่าน · *(ซิงค์คลาวด์นิสัย = slice ถัดไป)* · อัปเดตเงียบ
- **v2.37.0** *(เว็บ · BETA · silent)* — 🌙 **Epic B เริ่ม: ตัวติดตามนิสัย (slice 1)** — การ์ด **"นิสัยประจำวัน"** ในหน้าแรก (พับ/ขยายได้): บันทึก **การนอน** (ชั่วโมง +/- ทีละ 0.5 + อารมณ์ 😩😐😊😴) และ **อาหารเสริม** (วิตามินรวม/โอเมก้า 3/โปรไบโอติก/สังกะสี · แตะติ๊กรายวัน) · เก็บในเครื่อง + สำรองลง IndexedDB อัตโนมัติ · self-test 22 ข้อผ่าน · *(ก้าวเดิน + สั่งงานเสียง + ซิงค์คลาวด์ = slice ถัดไป)* · อัปเดตเงียบ
