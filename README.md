...
- **v2.46** — โหมดมืด (อัตโนมัติตามระบบ · ตั้งเวลาเอง · เปิด-ปิดเอง) · ปรับแต่งแถบล่างใช้ได้กับ Aurora
- **v2.45** — หน้าแรกวิดเจ็ต 4 ช่อง (น้ำ · คำแนะนำสุขภาพ · ก้าวเดิน · ออกกำลังกาย) · ช่องค้นหากล้อง+ไมค์ · หน้าถ่ายรูป AI ใหม่ · หน้ามื้ออาหารเพิ่ม/ลบได้ · หัวข้อกึ่งกลาง · ปุ่มย้อนกลับ · แก้ไขบั๊ก
