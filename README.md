...
- **v2.44** — Aurora Health UI v2 + หน้ามื้ออาหาร · แกลเลอรีรูปอาหาร (กดรูปดูได้หลายภาพ) · แก้ไขบั๊ก
- **v2.43** — ดีไซน์ใหม่ Aurora Health UI (เลือกได้ใน ตั้งค่า › รูปลักษณ์) · ย้ายการนับก้าวไปเวอร์ชั่นแอป (APK)
- **v2.42** — ปรับ UI การนอนให้กระชับ + บอกคุณภาพอัตโนมัติ · นับก้าวจากเซนเซอร์ของเครื่อง · ปรับปรุง UI
