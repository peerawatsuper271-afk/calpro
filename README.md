...
- **v2.31.2** *(APK + web · BETA · silent)* — 🛠️ แก้ขอบล่างไม่เต็มจอ (วอลเปเปอร์เครื่องรั่วหลังแถบนำทางโปร่งใส) — ทาสีพื้นแอปทึบที่ขอบล่าง + ตั้งแถบนำทาง Android เป็นดำ + พื้น native เป็นดำ (อัปเดตเงียบ)
